...
6831 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6842 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6829 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6811 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6787 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6681 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6676 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6655 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6653 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6668 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6652 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6720 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6648 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6674 rows and 6 columns.
...
An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6705 rows and 6 columns.

An object of class `tbl_df` (inherits from `tbl`, `data.frame`) with
6715 rows and 6 columns.
